...
public class TimerController {
  ...
  public Instant startTimer(@Validated @RequestBody StartTimerRequest startTimerRequest)
  ...
  public TogglProject createProject(
      @Validated @RequestBody CreateProjectRequest createProjectRequest) throws GitLabApiException {
